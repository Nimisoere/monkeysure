...
const CarBanner = ({ compare }) => {
  ...
  return (
    <section className="travel-banner flex flex-wrap">
      ...
      <div className="car-widget animate__animated animate__slideInUp">
        ...
        <FormGroup className="widget-form" inputs={inputs} actionText="Search" action={() => history.push(compare ? '/travel/compare-quotes' : '/travel/insurance-form')} />
      </div>
    </section>
  )
};
