  ...
  return (
    <header className="flex header items-stretch">
      <div className="container mx-auto items-stretch flex flex-wrap justify-between">
        ...
        <button onClick={() => setMobileMenu(!mobileMenu)} className="flex items-center sm:hidden px-3 py-2">
        ...
        <div className={`sm:flex ${mobileMenu ? '' : 'hidden'} sm:flex-wrap sm:w-auto w-full sm:justify-between justify-start sm:items-stretch`}>
